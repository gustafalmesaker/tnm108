...
#only four categories, fetch the training and testing data set
...
#we need to be able to convert the content of each string (each document) into a vector of numbers. Let’s compute first the sparse tf-idf matrix of the training data set
cv = CountVectorizer()
